...
mod tests {
    ...
    fn test_ta_sma() {
        ...
        // Setup historical data: [100, 102, 104, 106, 108] (oldest to newest, current = 110)
        let mut data = HashMap::new();
        data.insert("close".to_string(), vec![108.0, 106.0, 104.0, 102.0, 100.0]);
    ...
    fn test_ta_wma() {
        ...
        let mut data = HashMap::new();
        data.insert("close".to_string(), vec![2.0, 3.0, 4.0]);
        ctx.set_historical_provider(Box::new(MockHistoricalData { data }));
