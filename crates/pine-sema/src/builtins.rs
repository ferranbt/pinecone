...
const NAMESPACES: &[&str] = &[
    ...
    "array", "box", "color", "currency", "label", "log", "math", "matrix", "str", "ta",
    ...
    "line", "linefill", "table", "polyline", "map", "chart", "strategy", "request", "ticker",
    "syminfo", "timeframe", "session", "barstate", "adjustment", "alert", "barmerge", "dayofweek",
    "display", "dividends", "earnings", "extend", "font", "format", "hline", "input", "location",
    "order", "position", "scale", "settlement_as_close", "shape", "size", "splits", "text", "xloc",
    "yloc", "runtime", "month", "weekofyear",
];
...
const VARIABLES: &[&str] = &[
    ...
    "hl2", "hlc3", "ohlc4", "hlcc4", "bar_index", "last_bar_index", "time", "time_close",
    "time_tradingday", "timenow", "last_bar_time",
];

/// Built-in global functions callable without a namespace.
const FUNCTIONS: &[&str] = &[
    // Registered in this codebase.
    "na", "bool", "int", "float", "nz", "fixnan", "plot", "plotarrow", "plotbar", "plotcandle",
    "plotchar", "plotshape", "dayofmonth", "dayofweek", "hour", "minute", "month", "second", "year",
    // Common bare global functions in Pine v6.
    "fill", "bgcolor", "barcolor", "alertcondition", "input", "color", "string", "line",
];
